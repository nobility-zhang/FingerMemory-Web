...
public class WordCategoryMapperTests {
  ...
  public void insertOneWordCategoryTest() {
    ...
    WordCategory wordCategory2 = wordCategoryMapper.selectWordCategoryById((int) wordCategory1.getCategoryId());

    assertEquals(wordCategory1, wordCategory2);

    wordCategoryMapper.deleteWordCategoryById((int) wordCategory1.getCategoryId());
  }
